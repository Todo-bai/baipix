...
export const en = {
  ...
  'tool.line': 'Line',
  'tool.rect': 'Rectangle',
  'tool.roundRect': 'Rounded rectangle',
  ...
  'menu.adjustColors': 'Adjust colors…',
  'adjust.title': 'Adjust colors',
  'adjust.hue': 'Hue',
  'adjust.saturation': 'Saturation',
  'adjust.brightness': 'Brightness',
  'adjust.layer': 'Active layer',
  'adjust.allLayers': 'All layers',
  'adjust.palette': 'Adjust the palette too',
  'adjust.selectionOnly': 'Limited to the selection.',
